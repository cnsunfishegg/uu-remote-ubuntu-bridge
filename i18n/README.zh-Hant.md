...
此 fork 另提供 Ubuntu 26.04 / GNOME 50 的**預覽**安裝路徑：它會使用並驗證
系統的新版 `libei`，不會把 24.04 的舊相容函式庫載入 GNOME 50。它尚未完成與
24.04 基線相同的真實控制端驗收；部署前請閱讀
[26.04 移植說明](../docs/ubuntu-26-04-port.md)，並先完成其中六項驗收。
